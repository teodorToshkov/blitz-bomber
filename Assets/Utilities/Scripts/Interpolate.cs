...
public static class Interpolate
{
    ...
    /// <param name="endValue">End value.</param>
    /// <param name="currentTime">Current time.</param>
    public static UnityEngine.Color Linear(UnityEngine.Color startValue, UnityEngine.Color endValue, float currentTime, float duration)
    {
        UnityEngine.Color changeInValue = endValue - startValue;
        return changeInValue * currentTime / duration + startValue;
    }
    ...
    /// <param name="endValue">End value.</param>
    /// <param name="currentTime">Current time.</param>
    public static UnityEngine.Color EaseInQuad(UnityEngine.Color startValue, UnityEngine.Color endValue, float currentTime, float duration)
    {
        UnityEngine.Color changeInValue = endValue - startValue;
        currentTime /= duration;
        return changeInValue * currentTime * currentTime + startValue;
    ...
    /// <param name="endValue">End value.</param>
    /// <param name="currentTime">Current time.</param>
    public static UnityEngine.Color EaseOutQuad(UnityEngine.Color startValue, UnityEngine.Color endValue, float currentTime, float duration)
    {
        UnityEngine.Color changeInValue = endValue - startValue;
        currentTime /= duration;
        return startValue - changeInValue * currentTime * (currentTime - 2);
    }
    ...
    /// <param name="endValue">End value.</param>
    /// <param name="currentTime">Current time.</param>
    public static UnityEngine.Color EaseInOutQuad(UnityEngine.Color startValue, UnityEngine.Color endValue, float currentTime, float duration)
    {
        UnityEngine.Color changeInValue = endValue - startValue;
        currentTime /= duration / 2;
        if (currentTime < 1) return changeInValue / 2 * currentTime * currentTime + startValue;
        currentTime--;
        return startValue - changeInValue / 2 * (currentTime * (currentTime - 2) - 1);
    }
}
